...
type CPU struct {
	...
	SpeedMhz     string `xml:"SPEED,attr"`
...
type Dimm struct {
	SizeMb        string `xml:"SIZE,attr"`
	SpeedMhz      string `xml:"CFG_SPEED,attr"`
	Manufacturer  string `xml:"MANUFACTURER,attr"`
	Location      string `xml:"LOCATION,attr"`
	Serial        string `xml:"SN,attr"`
	ProductNumber string `xml:"PN,attr"`
}
...
type PlatformInfo struct {
	BiosVersion string `xml:"BIOS_VERSION,attr"`
	CpldRev     string `xml:"CPLD_REV,attr"`
	RedfishRev  string `xml:"REDFISH_REV,attr"`
...
type PowerSupply struct {
	...
	Ivrs          string `xml:"IVRS,attr"`
	Hotrep        string `xml:"HOTREP,attr"`
	Serial        string `xml:"SN,attr"`
	...
	MaxPower      string `xml:"MAXPOWER,attr"`
