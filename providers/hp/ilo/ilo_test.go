...
var (
	...
	Answers = map[string][]byte{
		...
		"/json/chassis_info":       []byte(`{"node_number":1,"chassis_sn":"CZ3916SD88","chassis_name":"HPE Apollo 4510 Gen10","chassis_pn":"864668-B21","ipdu_info":[],"chassis_power":646,"node_power":144}`),
	}
)
